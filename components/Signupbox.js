...
const Signupbox = ({ toggler }) => {
    ...
    return (
        ...
        <>
            <div className="flex flex-col md:h-[40%] md:w-[40%] h-[40%] w-[80%] shadow-xl fixed top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] z-[100] bg-white rounded-xl opacity-100  ">
                <div className="flex items-center px-5 py-3 border-b transition-all duration-300 ease-linear">
                    ...
                    <p className="font-poppins font-semibold md:text-base text-sm flex-grow text-center tracking-wider mr-3">Signup</p>
                </div>
